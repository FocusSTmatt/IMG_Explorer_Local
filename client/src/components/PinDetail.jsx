      ...
      client
        ...
        .then(() => {
          if(commentsArray === null){
            setCommentsArray([{comment: comment, postedBy: {userName: user.userName, image: user.image}}])
          } else {
            setCommentsArray(oldComments => [...oldComments, {comment: comment, postedBy: {userName: user.userName, image: user.image}}])
          }
          setComment('');
